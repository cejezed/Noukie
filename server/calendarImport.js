...
export class CalendarImportService {
    ...
    async importEventsForUser(userId) {
        const results = {
            imported: 0,
            skipped: 0,
            errors: []
        ...
        try {
            ...
            for (const googleEvent of googleEvents) {
                try {
                    ...
                    const importedEventData = this.googleCalendar.createImportedEventRecord(googleEvent, scheduleItem.id, userId);
                    if (existingImport) {
