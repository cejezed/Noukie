...
import { Plus, User, BookOpen, CheckCircle2, Info, Eye } from "lucide-react";
...
export default function ParentDashboard() {
    ...
    if (selectedChild) {
        return (_jsx(ChildDashboard, { child: selectedChild, onBack: () => setSelectedChild(null) }));
    }
